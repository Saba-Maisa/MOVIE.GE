...
const sliderContainerBox = document.querySelector('.slider-container-box')
let carentIndex  = [0];
...
function  movieApi (movie){
   ...
   axios.get(`https://api.themoviedb.org/3/movie/${movie}/videos?api_key=${api}&language=en-US`)
